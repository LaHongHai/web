...
# list1 =[]
# for tour in mylist:
#     if tour[field1]=='Southern Vietnam':
#         list1.append(tour)
# print (list1)
# list2=[]
# for tour in mylist:
#     if tour[field1]=="Northern Vietnam":
#         list2.append(tour)
# print (list2)
# list3=[]
# for tour in mylist:
#     if tour[field1]=="Central Vietnam":
#         list3.append(tour)
# print (list3)
# list4=[]
# for tour in mylist:
#     if tour[field2]=="Winter":
#         list4.append(tour)
# print (list4)

# list5=[]
# for tour in mylist:
#     if tour[field2]=="Summer":
#         list5.append(tour)
# print (list5)

# list6=[]
# for tour in mylist:
#     if tour[field2]=="Autumn":
#         list6.append(tour)
# print (list6)
# list7=[]
# for tour in mylist:
#     if tour[field2]=="Spring":
#         list7.append(tour)
# print (list7)
# list8=[]
# for tour in mylist:
#     if tour[field3]=="Mountainous":
#         list6.append(tour)
# print (list8)
# list9=[]
# for tour in mylist:
#     if tour[field3]=="Coastal":
#         list9.append(tour)
# print (list9)
# list10=[]
# for tour in mylist:
#     if tour[field3]=="Plain":
#         list10.append(tour)
# print (list10)
# list11=[]
# for tour in mylist:
#     if tour[field3]=="River":
#         list11.append(tour)
# print (list11)
